...
print_message "To start deployment of the ansible playboot, run: incus exec ${DEPLOY_NAME} -- ansible-playbook -i /root/cdt-windowsansible/inventory/hosts /root/cdt-windowsansible/all.yml"
